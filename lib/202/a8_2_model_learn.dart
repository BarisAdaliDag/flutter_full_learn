...
//bu deger saddece init zamaninda gelecek baska zamanda hata
class PostModel6 {
...
class PostModel8 {
  ...
  PostModel8 copyWith({
    //yeni instance olusturmak istediginde verileri degismesini istedigini degistirir geri kalan nesnenin ozellikleri tutar
    int? userId,
    int? id,
    String? title,
    String? body,
