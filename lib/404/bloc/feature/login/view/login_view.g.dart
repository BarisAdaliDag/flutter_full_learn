    ...
    return BlocSelector<LoginCubit, LoginState, bool>(
      ...
      builder: (context, state) {
        return IgnorePointer(
          //IgnorePointer view etkileşimi engelliyor. Loadıng state durumları için kullanılıyor
          ignoring: state,
          child: AnimatedOpacity(
            duration: Duration(milliseconds: 500), // context.durationLow
            opacity: state ? 0.3 : 1,
            child: Column(
              children: [
                Padding(
                  ...
                  child: TextFormField(
                    ...
                    validator: (String? data) => (data?.isNotEmpty ?? false)
                        ? null
                        : 'Problem ', //isValidEmail
                  ),
                ),
                Padding(
                  padding: const PagePadding.bottom(),
